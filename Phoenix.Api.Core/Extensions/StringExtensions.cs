...
namespace Phoenix.Api.Core.Extensions
{
    public static class StringExtensions
    {
        ...
        public static Guid? ToGuid(this string id)
        {
            ...
            if (!Guid.TryParse(id, out var identityID))
                return null;
        ...
        {
            return sql?.Replace("%", "").Replace("@", "").ToUpper().Trim();
        }
        ...
        public static int? SqlParameterSafetyCheckNullableInt(this string sql)
        {
            ...
            Int32.TryParse(sql, out var value);
            if (value > 0)
            {
                return value;
            }
        ...
        public static DateTime ToDateTimeFromYearMonth(this string ym)
        {
            ...
            if (Int32.TryParse(y, out var year) == false)
                return nullDate;
            if (Int32.TryParse(m, out var month) == false)
                return nullDate;
